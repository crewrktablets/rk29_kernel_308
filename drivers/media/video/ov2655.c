...
#define OV2655_BITSHIFT_MIRROR	3
#define OV2655_BITMASK_MIRROR	(0x01<<OV2655_BITSHIFT_MIRROR)
#ifndef OV2655_MIRROR
#define OV2655_MIRROR	0
#endif

#define OV2655_BITSHIFT_FLIP	0
#define OV2655_BITMASK_FLIP		(0x01<<OV2655_BITSHIFT_FLIP)
#ifndef OV2655_FLIP
#define OV2655_FLIP		0
#endif
...
static struct reginfo sensor_init_data[] =
{
    ...
    {0x3082, 0x01},
    {0x30f4, 0x01},
	{0x3090, (0x3b & ~OV2655_BITMASK_MIRROR) | (OV2655_MIRROR<<OV2655_BITSHIFT_MIRROR)},
    ...
    {0x3350, 0x31},//0x37},//0x33},
    {0x3351, 0x25},//0x27},//0x28},
    {0x3352, 0x80},//0x00},
    {0x3353, 0x14},//0x16},
    {0x3354, 0x00},
    {0x3355, 0x84},//0x85},
    ...
    {0x3069, 0x84},
    {0x307c, (0x13 & ~OV2655_BITMASK_FLIP) | (OV2655_FLIP<<OV2655_BITSHIFT_FLIP)},
    {0x3087, 0x02},
...
static struct class *ov2655_class = NULL;
static CLASS_ATTR(ov2655, 0666, ov2655_show, ov2655_store);
			 ...
			 const struct i2c_device_id *did)
{
	...
	ov2655_class = class_create(THIS_MODULE, "ov2655");
	if (IS_ERR(ov2655_class)) 
	{
		printk("Create class ov2655.\n");
		return -ENOMEM;
	}
	class_create_file(ov2655_class,&class_attr_ov2655);
...
static int i2c_probe()
{
    ...
    ret = gpio_request(RK29_PIN5_PD7, "camera powerdown");
    if (ret) {
        printk("gpio_request failed\n");
    }
    gpio_set_value(RK29_PIN5_PD7, 1);
    gpio_direction_output(RK29_PIN5_PD7, 1);
    mdelay(2000);
    gpio_set_value(RK29_PIN5_PD7, 1);
    mdelay(2000);

    if(i2c1_prober_verify(0x30, 0x300a, 2, 1, 0x26) == 0) {
        if(i2c1_prober_verify(0x30, 0x300b, 2, 1, 0x56) == 0) {
                printk("%s OK\n", __func__);
                ret=0;
        }
    }
...
struct cam_sensor_info cam_sensor_info_ov2655={
    "ov2655",
    2,
    1,
    0x60>>1,
...
EXPORT_SYMBOL_GPL(cam_sensor_info_ov2655);
