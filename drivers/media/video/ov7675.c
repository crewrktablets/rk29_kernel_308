...
/* Flip configuration handled by sensor chip.
 * Loox CM9  4.1.1: 1
 * Loox CM10 4.1.2: 1
 *
 */
...
static struct reginfo sensor_init_data[] =
{
	...
	{0x0f, 0x4b},
	{0x16, 0x02},
	{0x1e, 0x07 | (OV7675_MIRROR << 5) | (OV7675_FLIP << 4)},
	{0x21, 0x02},
	{0x22, 0x91},
	{0x29, 0x07},
	{0x33, 0x0b},
...
static struct class *ov7675_class = NULL;
static CLASS_ATTR(ov7675, 0666, ov7675_show, ov7675_store);
			 ...
			 const struct i2c_device_id *did)
{
	...
	ov7675_class = class_create(THIS_MODULE, "ov7675");
	if (IS_ERR(ov7675_class)) 
	{
		printk("Create class ov7675.\n");
		return -ENOMEM;
	}
	class_create_file(ov7675_class,&class_attr_ov7675);
...
struct cam_sensor_info cam_sensor_info_ov7675={
    "ov7675",
    1,
    1,
    0x42>>1,
...
EXPORT_SYMBOL_GPL(cam_sensor_info_ov7675);
